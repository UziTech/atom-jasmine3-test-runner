...
export default class J3ReporterView {
	...
	isPaused() {
		return this.props.pausing || !!this.props.pausedAt;
	}
			...
			<div className="j3-spec-reporter-container">
				<div className="spec-reporter">
					...
					<div className={`status alert ${statusClass}`}>
						<TimerView startedAt={this.props.startedAt} endedAt={this.props.endedAt} paused={!!this.props.pausedAt} timePaused={this.props.timePaused} />
